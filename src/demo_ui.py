...
The page loads a case, retrieves evidence from the student memory implementation,
shows the budgeted context, and supports follow-up chat on the same thread.
...
def retrieve_for_case(
    ...
    layers = {layer: "" for layer in LAYER_COLORS}

    # E10 supplies a reproducible fixture; other cases start from their source
    # thread and retain turns added through this UI session.
    ...
    wanted = set(case.get("retrieve_layers") or ([] if expected == "mixed" else [expected]))
    if expected == "mixed" and not wanted:
        ...
        try:
            ...
            if gemini_available():
                try:
                    ...
                    reply = ("_(Gemini is temporarily unavailable — showing retrieved context instead)_\n\n"
